							...
							<div class="message" v-else-if="message.type === 'TIMCustomElem'">
								<div v-if="message.payload.data === 'survey'" class="survey">
									...
									<div class="description">
										<Irate disabled="true" :value="message.payload.description">
										</Irate>
									</div>
...
<script>
	...
	import Iavatar from '../../static/iview/avatar/index'
	import Iinput from '../../static/iview/input/index'
	import icon from '../../static/component/icon/index'
	import Irow from '../../static/iview/row/index'
	import Iicon from '../../static/iview/icon/index'
	import Icol from '../../static/iview/col/index'
	import Irate from '../../static/iview/rate/index'
	import Imodel from '../../static/iview/modal/index'
